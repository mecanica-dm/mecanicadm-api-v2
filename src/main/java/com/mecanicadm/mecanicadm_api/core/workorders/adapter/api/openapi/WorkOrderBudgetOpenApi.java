...
public interface WorkOrderBudgetOpenApi {
    ...
    ResponseEntity<Void> adjustBudget(UUID workOrderId, ManuallyAdjustWorkOrderBudgetCommand cmd);
    ...
    @ApiResponse(responseCode = "400", description = "Dados inválidos", content = @Content)
    @ApiResponse(responseCode = "404", description = "Ordem de serviço ou orçamento não encontrado", content = @Content)
    ResponseEntity<Void> decideBudget(UUID workOrderId, DecideWorkOrderBudgetCommand cmd);
